...
/**
    * Enable static files for any remaining wwwroot assets.
    * Game artwork now lives in the React app (frontend/src/assets),
    * so the backend no longer serves character or background images.
    */
app.UseStaticFiles();
app.UseRouting();
