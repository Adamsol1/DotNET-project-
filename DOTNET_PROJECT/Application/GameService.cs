...
private readonly IUnitOfWork _uow;
    ...
    // public async Task<int> GetStartNodeIdAsync()
    // {
    //     // Enten hardkod 1, eller hent fra DB hvis du har en "IsStart" flagg.
    //     var firstId = await _uow.StoryNodeRepository.GetFirstIdAsync(); // lag denne i repo, ellers returner 1
    //     return firstId == 0 ? 1 : firstId;
    // }
